...
func TestPizzaDecorator_AddIngredient(t *testing.T) {
	...
	if !strings.Contains(pizzaResult, expectedText) {
		t.Errorf("When calling the add ingredient of the pizza decorator it"+
			" must return the text %s ", expectedText)
...
func TestOnion_AddIngredient(t *testing.T) {
	...
	if err == nil {
		t.Errorf("When calling AddIngredient on the onion decorator whithout"+
			" and ingredientAdd on its Ingredient field must return an error,"+
...
func TestMeat_AddIngredient(t *testing.T) {
	...
	if err == nil {
		t.Errorf("When calling AddIngredient on the meat decorator without"+
			" and ingredientAdd in its Ingredient field must return an error,"+
